                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="notes" name="notes" rows="4"
                                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm">{{ $order->notes }}</textarea>
                                ...
                                <div class="bg-gray-50 p-4 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <p class="text-sm text-gray-500">Order Number: <span
                                                    class="text-gray-900">{{ $order->order_number }}</span></p>
